      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
            <h1 class="mb-3 text-9" style="letter-spacing: 0.03em">자유게시판</h1>
    ...
    <div class="wrap">
      <div class="left for">
        ...
        <div>
          ...
          &lt;%&ndash;<a href="./theFirstStory.do">1등당첨자이야기</a>&ndash;%&gt;
        </div>
      </div>
      <div class="content">
        <div class="head">
          ...
          <h5>
            ...
            <a href="javascript:goToMenu(type)"><img src="../img/arrow.png"> 자유게시판</a>
          </h5>
        </div>
...
<script type="text/javascript">
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          mstr += '<a href="/board/readingPostBoard.do?type=01&seq='+getList.seq+'">';
  ...
  function editingPostBoard(){
    ...
    else location.href="/board/editingPostBoard.do?type=01";
  }
</script>
