...
<script type="text/javascript">
  ...
  function paging(currentPage) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          mstr += '<a href="/board/readingPostBoard.do?type=03&seq='+getList.seq+'">';
    ...
    function table_click_function(){
      $("#table tr").click(function() {
        ...
        location.href="/board/readingPostBoard.do?type=03&seq=" + $(this).children().eq(0).text();//게시판 이동
      });
    }
  }
  ...
  function editingPostBoard(){
    ...
    else location.href="/board/editingPostBoard.do?type=03";
  }
</script>
