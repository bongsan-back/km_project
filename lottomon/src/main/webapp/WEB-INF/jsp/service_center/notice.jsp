      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
            <h1 class="mb-3 text-9" style="letter-spacing: 0.03em">토론방</h1>
  ...
  <div class="service_main">
    <div class="wrap">
      <div class="left for">
        <h2>고객센터</h2>
        <div>
          <a href="./notice.do" class="on">공지사항</a>
          <a href="./mattersForInquiry.do">1:1문의하기</a>
        </div>
      </div>
      <div class="content">
        <div class="head">
          ...
          <h5>
            ...
            <a href="#"><img src="../img/arrow.png"> 공지사항</a>
          </h5>
        </div>
        ...
        <div class="table">
          ...
          <p class="btn"><a href="/board/editingPostBoard.do?type=11">글쓰기</a></p>
        </div>
  ...
  function paging(currentPage) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          mstr += '<a href="/board/readingPostBoard.do?type=11&seq='+getList.seq+'">';
    ...
    function table_click_function(){
      $("#table tr").click(function() {
        ...
        location.href="/board/readingPostBoard.do?type=11&seq=" + $(this).children().eq(0).text();//게시판 이동
      });
    }
  }
</script>
